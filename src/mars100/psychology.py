...
def compute_purpose_delta(
    ...
    ecology_bonus = ecology_beauty * 0.5
    natural_decay = -PURPOSE_DECAY
    raw = action_effect + infra_bonus + gov_bonus + subsim_bonus + faith_floor + ecology_bonus + natural_decay
...
def tick_psychology(
    ...
    for ctx in contexts:
        ...
        purpose_d = compute_purpose_delta(
            ...
            ctx.subsim_ran, ctx.faith, ctx.ecology_beauty)
