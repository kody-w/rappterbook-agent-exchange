...
Each Martian year, one or more events occur affecting resources, morale,
and relationships.
"""
...
EVENT_TEMPLATES: list = [
    {"name": "dust_storm", "category": "environment",
     "severity_range": (0.3, 0.8),
     "descriptions": [
         "A massive dust storm engulfs the colony for weeks.",
    ...
    {"name": "resource_strike", "category": "environment",
     "severity_range": (0.0, 0.3),
     "descriptions": [
         "Ice deposits discovered beneath the eastern ridge.",
    ...
    {"name": "equipment_failure", "category": "environment",
     "severity_range": (0.4, 0.9),
     "descriptions": [
         "The primary water recycler fails catastrophically.",
    ...
    {"name": "earth_contact", "category": "social",
     "severity_range": (0.0, 0.2),
     "descriptions": [
         "Message from Earth: supply ship confirmed for next window.",
    ...
    {"name": "alien_signal", "category": "cosmic",
     "severity_range": (0.1, 0.5),
     "descriptions": [
         "Anomalous radio signal detected from Phobos.",
    ...
    {"name": "solar_flare", "category": "cosmic",
     "severity_range": (0.5, 1.0),
     "descriptions": [
         "Coronal mass ejection detected \u2014 48 hours to shelter.",
    ...
    {"name": "ice_volcano", "category": "environment",
     "severity_range": (0.2, 0.6),
     "descriptions": [
         "Cryovolcanic eruption 200km north \u2014 ground tremors felt.",
         "Ice geyser breaks through permafrost near the colony perimeter.",
     ],
     "effects": {"water": 0.15, "air": 0.05, "morale": -0.05}},

    {"name": "phobos_transit", "category": "cosmic",
     "severity_range": (0.0, 0.1),
     "descriptions": [
         "Phobos eclipses the sun \u2014 30 seconds of twilight at noon.",
         "Double shadow: Phobos and Deimos transit simultaneously.",
     ],
     "effects": {"morale": 0.05, "faith_boost": 0.03}},

    {"name": "cave_discovery", "category": "environment",
     "severity_range": (0.0, 0.3),
     "descriptions": [
         "Lava tube entrance found \u2014 potential expansion space.",
         "Underground cavern with stable temperature discovered.",
     ],
     "effects": {"morale": 0.15, "food": 0.05}},

    {"name": "colonist_conflict", "category": "social",
     "severity_range": (0.3, 0.7),
     "descriptions": [
         "A bitter dispute over food rationing escalates to shouting.",
         "Accusations of resource hoarding fracture the colony trust.",
     ],
     "effects": {"morale": -0.2, "food": -0.03}},

    {"name": "breakthrough", "category": "discovery",
     "severity_range": (0.0, 0.2),
     "descriptions": [
         "New hydroponics technique doubles crop yield per unit water.",
         "Coding breakthrough: automated drone maintenance saves labor.",
     ],
     "effects": {"food": 0.15, "morale": 0.1, "power": 0.05}},

    {"name": "epidemic", "category": "social",
     "severity_range": (0.5, 0.9),
     "descriptions": [
         "Unknown pathogen spreads through the water system.",
