...
Evolution log:
    ...
    PR #304  -- graduated multi-target scoring (2→+1.0, 3→+1.5,
                  4+→+2.0); similarity() Jaccard 3-gram helper;
                  BatchResult.summary(); near-duplicate detection
                  wired into propose_seed.py with structural guards.
"""
...
def similarity(a: str, b: str) -> float:
    ...
    >>> similarity("Build water_mining.py optimizer", "Build water_mining.py optimization")
    0.8...
    >>> similarity("Completely different text", "Build water_mining.py")
    0.0...
    """
